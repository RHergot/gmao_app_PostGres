...
class PieceRepository:
    ...
    def add(self, p: Piece) -> Optional[int]:
        ...
        try:
            ...
            logger.warning(f"Échec ajout pièce '{p.nom}'. Ref unique%s FK Fournisseur%s {e}")
    ...
    def update(self, p: Piece) -> bool:
        ...
        try:
            ...
            return success
             ...
             logger.warning(f"Échec màj pièce ID {p.id_piece}. Ref unique%s FK Fournisseur%s {e}")
             if 'PIECE.reference' in str(e):
    ...
    def update_stock_level(self, piece_id: int, new_stock_actuel: int) -> bool:
    ...
    def delete(self, p_id: int) -> bool:
        ...
        try:
            ...
            return success
             ...
             logger.error(f"Impossible supprimer Pièce ID {p_id}. Référencée (Cmd/Intervention)%s {e}")
