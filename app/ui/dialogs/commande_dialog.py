...
from app.utils.exceptions import PermissionError # Assurez-vous d'avoir cet import aussi
...
class CommandeDialog(QDialog):
    ...
    current_user_obj.role
        ...
        except PermissionError as pe: # Attraper l'erreur de permission spécifiquement
