...
from .serializers import (
    OrdreTravailSerializer, TechnicienSerializer, PieceSerializer,
    MaintenanceSerializer, MouvementStockSerializer, MachineSerializer,
    ReservationPieceSerializer, RapportInterventionSerializer
)
...
class TechnicienViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    """
    queryset = Technicien.objects.filter(actif=True)
...
class OrdreTravailViewSet(viewsets.ModelViewSet):
    ...
    filterset_fields = ['statut', 'priorite', 'type', 'technicien_assigne', 'machine__site']
